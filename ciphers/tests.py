...
class CaesarTestCase(TestCase):
    ...
    def can_decode_smaller_ciphers(self):
        offset = 3
        caesar_one = Caesar.objects.create('OLHV')
        caesar_two = Caesar.objects.create('PBVWHUB VKDFN')
        caesar_three = Caesar.objects.create('SLWW')
        caesar_four = Caesar.objects.create('OAUVG')
        caesar_five = Caesar.objects.create('EWTUG AQW OCTKNAP')
    ...
    def test_can_decode_carpet_diem_cipher(self):
        offset = 3
        caesar = Caesar.objects.create('SXEHUWB LV WKH JUHDWHVW PBVWHUB RI DOO DOVR: JR RXWVLGH DQG PDNH IULHQGV.')
    ...
    def test_can_decode_gideon_rises_cipher(self):
        offset = 3
        caesar = Caesar.objects.create('ELOO LV ZDWFKLQJ')
        self.assertEqual(caesar.decode(offset), 'BILL IS WATCHING')

    def test_can_decode_shorts_ciphers(self):
        offset = 3
        caesar_one = Caesar.objects.create('IURP WKH ILUVW XQWLO WKH ODVW VHDUFK WKH')
        caesar_two = Caesar.objects.create('WKHP DOO ZHOFRPH WR JUDYLWB IDOOV')
        caesar_three = Caesar.objects.create('FRGHV RI FUHGLWV SDVW RQH PHDQV RQH VR VHDUFK')
    ...
    def test_can_decode_scaryoke_cipehrs(self):
        offset = 3
        caesar_one = Caesar.objects.create('TEV FP TBKAV PL MBOCBZQ')
        caesar_two = Caesar.objects.create('ZDWFK RXW')
        caesar_three = Caesar.objects.create('NLOO PH SOHDVH')
    ...
    def test_can_decode_scaryoke_cipehrs(self):
        offset = 3
        caesar_one = Caesar.objects.create('ZLGGOH')
        caesar_two = Caesar.objects.create('VKLIWHU')
        caesar_three = Caesar.objects.create('ZKDWHYV')
        caesar_four = Caesar.objects.create('EHDUR')
    ...
    def test_can_decode_not_what_he_seems_cipher(self):
        offset = 3
        caesar = Caesar.objects.create('JXYDPHQW')
